...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget child = scale == 1.0
        ? this.child
        : ScaleSizeWidget(
            scale: scale, child: this.child, textAligned: textAlign);
...
/// 指示器抽象
abstract class TabIndicatorPainter extends CustomPainter {
  TabIndicatorPainter({Listenable? repaint}) : super(repaint: repaint);
...
class _IndicatorPainter extends TabIndicatorPainter {
  _IndicatorPainter({
...
/// 自定义的painter
class CustomIndicatorPainter extends TabIndicatorPainter {
  final TabController controller;
  final List<GlobalKey> tabKeys;
